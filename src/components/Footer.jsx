...
const Footer = () => {
  return (
    <footer className="footer footer-horizontal footer-center text-base-content rounded p-10 
      bg-gradient-to-r from-[#6A00FF] to-[#9D4EDD] text-white shadow-lg shadow-purple-700/30">

      {/* Main links */}
      <nav className="grid grid-flow-col gap-4">
        <a className="link link-hover hover:text-pink-200 transition" href="#">
          About us
        </a>
        <a className="link link-hover hover:text-pink-200 transition" href="#">
          Contact
        ...
        <div className="grid grid-flow-col gap-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              ...
              <path d="M18.901 1.144h3.585l-7.34 8.791L24 22.856h-8.243L8.601 13.92 1.625 22.856H0L9.07 11.23L0 1.144h8.461l5.372 6.786L18.901 1.144ZM17.818 20.678h2.052L6.471 3.253H4.257l13.561 17.425Z"/>
            </svg>
          </a>
      ...
      {/* COPYRIGHT */}
      <aside className="mt-4 text-pink-100">
        <p>
          Copyright © {new Date().getFullYear()} — All rights reserved by 
          <strong> AI Models Inventory Manager</strong>.
        </p>
      </aside>
    </footer>
  );
