    ...
    <div  className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      ...
      <div className="card-body">
        <div className="flex items-center justify-between">
          <div className="badge  p-2 badge-xs badge-primary bg-gradient-to-r from-[#6A00FF] to-[#9D4EDD] rounded-full">
            {framework}
          </div>
          <h4 className="line-clamp-1 bg-gradient-to-r from-[#6A00FF] to-[#9D4EDD] bg-clip-text text-transparent">
